...
export function adminAddChecklistItem(activityId, body) {
    return apiFetch(`/api/admin/volunteering/activities/${activityId}/checklist`, {
        method: 'POST',
        body: JSON.stringify(body),
    });
}

export function adminUpdateChecklistItem(activityId, itemId, body) {
    return apiFetch(`/api/admin/volunteering/activities/${activityId}/checklist/${itemId}`, {
        method: 'PATCH',
        body: JSON.stringify(body),
    });
}

export function adminDeleteChecklistItem(activityId, itemId) {
    return apiFetch(`/api/admin/volunteering/activities/${activityId}/checklist/${itemId}`, {
        method: 'DELETE',
    });
}
...
export function donorCheckItem(activityId, scheduleId, itemId) {
    return apiFetch(`/api/volunteering/activities/${activityId}/schedules/${scheduleId}/checklist/${itemId}/check`, {
        method: 'POST',
    });
}

export function donorUncheckItem(activityId, scheduleId, itemId) {
    return apiFetch(`/api/volunteering/activities/${activityId}/schedules/${scheduleId}/checklist/${itemId}/check`, {
        method: 'DELETE',
    });
}
