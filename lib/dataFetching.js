...
export function getGoogleSheetAppUrl() {
    return typeof import.meta !== "undefined" && import.meta.env && import.meta.env.NEXT_PUBLIC_GOOGLE_SHEET_APP_URL;
}

/** Sheet gid for funded tiers. Optional; if unset, exports first sheet. */
export function getFundedTiersGid() {
    const v = typeof import.meta !== "undefined" && import.meta.env && import.meta.env.NEXT_PUBLIC_GOOGLE_SHEET_FUNDED_TIERS_GID;
    return v != null && String(v).trim() !== "" ? String(v).trim() : null;
}

/** Sheet gid for donations. Optional; if unset, exports first sheet. */
export function getDonationsGid() {
    const v = typeof import.meta !== "undefined" && import.meta.env && import.meta.env.NEXT_PUBLIC_GOOGLE_SHEET_DONATIONS_GID;
    return v != null && String(v).trim() !== "" ? String(v).trim() : null;
}
