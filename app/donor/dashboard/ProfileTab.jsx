...
export default function ProfileTab({ profileForm, setProfileForm, passwordForm, setPasswordForm, engagementForm, setEngagementForm, profile, handleProfileUpdate, handlePasswordUpdate, handleEngagementUpdate }) {
    ...
    const currentPasswordToggleLabel = showCurrentPassword ? donorText.hidePassword : donorText.showPassword;
    const newPasswordToggleLabel = showNewPassword ? donorText.hidePassword : donorText.showPassword;
    const confirmPasswordToggleLabel = showConfirmPassword ? donorText.hidePassword : donorText.showPassword;
            ...
            <div className="dashboard-card">
                ...
                <form className="dashboard-form" onSubmit={handlePasswordUpdate}>
                    <div className="dashboard-password-field">
                        <input
                            className="dashboard-input dashboard-input--with-toggle"
                            type={showCurrentPassword ? 'text' : 'password'}
                            value={passwordForm.currentPassword}
                            onChange={(e) => setPasswordForm((prev) => ({ ...prev, currentPassword: e.target.value }))}
                            placeholder={donorText.curPwd}
                        />
                        <button type="button" onClick={() => setShowCurrentPassword(v => !v)} className="dashboard-password-toggle" aria-label={currentPasswordToggleLabel}>
                            {showCurrentPassword ? (
                    ...
                    <div className="dashboard-password-field">
                        ...
                        />
                        <button type="button" onClick={() => setShowNewPassword(v => !v)} className="dashboard-password-toggle" aria-label={newPasswordToggleLabel}>
                            {showNewPassword ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                            ) : (
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                    ...
                    <div className="dashboard-password-field">
                        ...
                        />
                        <button type="button" onClick={() => setShowConfirmPassword(v => !v)} className="dashboard-password-toggle" aria-label={confirmPasswordToggleLabel}>
                            {showConfirmPassword ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                            ) : (
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
